            ...
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid grid-cols-6 gap-10 row-gap-6 mb-8">
                    <div className="sm:col-span-3 col-span-6 d w-auto">
                        ...
                        <div className="mt-6">
                            <p className="text-sm">
                                Nusantara Baru, Indonesia Maju! HUT ke-79 RI menjadi batu loncatan besar, menyongsong Ibu Kota baru,
                                pergantian kepemimpinan, dan Indonesia Emas 2045. Bersatu, wujudkan mimpi Indonesia Maju!
                            </p>
